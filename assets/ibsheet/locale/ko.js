...
IBSMSG.Ko = {
  "Lang": {
    "Alert": {
      ...
      "SearchNotFound": "일치하는 검색 결과가 없습니다.",
      "Invalid": "잘못된 값",
      ...
      "TooManyStackedRows": "고정이 허용되는 개수는 <span style='color: red;'>%d개</span> 입니다.",
      ...
      "ApiError": "'%1' 함수에서 오류가 발생하였습니다.",
      "RemoveNotWorking": "%1에서는 %2 행을 삭제할 수 없습니다.",
      "EditNotWorking": "셀을 편집 할 수 없습니다.",
      "ExportDataErrMsg": "IBSheet의 JSZip 모듈을 찾을 수 없어 데이터를 다운로드할 수 없습니다.",
      "ImportDataErrMsg": "IBSheet의 JSZip 모듈을 찾을 수 없어 데이터를 업로드할 수 없습니다.",
      "NoXlsxFullMinJS": "xls 파일 형식은 지원하지 않습니다.",
      "CookieNotFound": "쿠키를 찾을 수 없습니다. 브라우저에서 쿠키가 허용되어 있는지 확인 바랍니다.",
      "TabNameEmpty": "입력한 시트의 이름이 잘못되었습니다.",
      "EmptyInfoErr": "시트 정보를 입력해 주세요.",
      "InputInfoErr": "입력한 시트 정보가 올바르지 않습니다.",
      "NoFilterDataForPivot": "피벗 시트를 만들기 위한 필터 데이터가 한 건도 존재하지 않습니다.",
      "NoExcelPlugin": "XlsImportMode를 사용하시려면 엑셀 플러그인을 포함해주셔야 됩니다."
    },
    "Text": {
      ...
      "Password": "***",
      "DefaultsNone": "모두 지우기",
      "RadioFilterOff": "<button style='white-space: nowrap;'>전체취소</button>",
      ...
      "RenderProgressText": "%cnt 페이지 중 %pos 페이지가 완료되었습니다.",
      "RenderProgressCancel": "Render on background",
      "PrintProgressCaption": "파일 생성",
      "PrintProgressText": "총 %cnt 개의 행 중 %pos 개 행이 완료되었습니다.",
      "PrintProgressCancel": "취소",
      "ExportProgressCaption": "파일 생성",
      "ExportProgressText": "총 %cnt 개의 행 중 %pos 개 행이 완료되었습니다.",
      "ExportProgressCancel": "취소",
      "ExpandProgressCaption": "모든행을 확장",
      "ExpandProgressText": "총 %cnt 개의 행 중 %pos 개 행이 완료되었습니다.",
      ...
      "NoNumber": "숫자가 아닙니다.",
      "EditMaskError": "%1 행 %2 열 셀에 입력가능하지 않은 데이터가 포함되어 있습니다.",
      ...
      "ConfirmSaveDataRows1": "<div><div>추가: %1건</div><div>수정: %2건</div> 저장하시겠습니까?</div>",
      "ConfirmSaveDataRows2": "<div><div>전체: %1건</div> 저장하시겠습니까?</div>",
      "ConfirmSaveDataRows3": "<div><div>추가: %1건</div><div>수정: %2건</div><div>삭제: %3건</div><div>이동: %4건</div> 저장하시겠습니까?</div>",
      ...
      "InvaildJSONParse": "잘못된 데이터구조, 파싱 오류",
      "ErrorSearch": "조회중 오류가 발생하였습니다.",
      ...
      "PageLengthMessage": "시트에 보여질 개수를 선택하세요",
      "Filter_13": {
        "Up": "상위",
        "Down": "하위",
        "Item": "항목",
      ...
      "FilterTip": {
        "Date": [
          "날짜 필터 방법",
          "1. 특정일자 필터링",
          "년월일을 구분자 없이 입력합니다. ex) '20240125'",
          "2. 기간 필터링 방법",
          "년월일~년월일 형식으로 띄어쓰기 없이 입력합니다. ex) '20240101~20240131'"
        ],
        "Number": [
          "숫자 필터 방법",
          "1. 일반적인 필터링",
          "숫자를 입력 후 필터 셀 앞에 icon을 클릭하여 필터 옵션을 선택합니다.",
          "2. 구간 필터링",
          "필터링하고자 하는 숫자를 ~로 연결한 형식으로 띄어쓰기 없이 입력합니다. ex) '100~4000'"
        ],
        "Text": [
          "문자 필터 방법",
          "1. 일반적인 필터링",
          "텍스트를 입력 후 필터 셀 앞에 icon을 클릭하여 필터 옵션을 선택합니다.",
          "2. or 필터링",
          "필터링하고자 하는 문자를 ;로 연결한 형식으로 띄어쓰기 없이 입력합니다. ex) '김정호;장순연'",
          "3. and 필터링",
          "필터링하고자 하는 문자를 ,로 연결한 형식으로 띄어쓰기 없이 입력합니다. ex) '김정호,장순연'"
        ]
      },
      "StatusLabelChange": "$1 열 $2 번째 행 셀의 값이 $3 에서 $4 (으)로 수정되었습니다.",
      "StatusLabelAllChecked": "전체 체크 박스가 $1 되었습니다.",
      "StatusLabelDataLoaded": "$1 건의 $2 데이터가 로드되었습니다.",
      "StatusLabelValueUndo": "$1 열 $2 번째 행 셀의 값이 수정 취소 되었습니다.",
      "StatusLabelSearch": "조회 ",
      "StatusLabelExcel": "엑셀 ",
      "StatusLabelFileUpload": "$1 열 $2 번째 행 셀의 파일이 $3 (으)로 업로드되었습니다.",
      "StatusLabelFileDelete": "$1 열 $2 번째 행 셀의 파일이 제거되었습니다.",
      "StatusLabelColMove": "$1 열이 $2 열의 $3 으로 이동되었습니다.",
      "StatusLabelRowMove": "$1 행이 $2 행의 $3 으로 이동되었습니다.",
      "StatusLabelSort": "$1 열이 $2 으로 정렬되었습니다.",
      "StatusLabelSortClear": "정렬이 초기화되었습니다.",
      "StatusLabelFilter": "$1 열이 $2 (으)로 필터링되었습니다.",
      "StatusLabelFilterClear": "필터링이 초기화되었습니다.",
      "StatusLabelNullValue": "빈 값",
      "StatusLabelMovingUp": "위쪽",
      "StatusLabelMovingDown": "아래쪽",
      "StatusLabelSameLevel": "하위 레벨행",
      "FilterDialog": {
        "TextFilter": "텍스트 필터",
        "NumberFilter": "숫자 필터",
        "DateFilter": "날짜 필터",
        "EmptyValue": "(빈 값)",
        "TextFilterPlaceHolder": "~로 구간 필터 설정 가능"
      },
      "ValidationError": {
      ...
      "SizeError": "%1 행 %2 열 셀의 글자수가 입력가능한 글자수를 초과했습니다.",
      "ResultMaskError": "%1 행 %2 열 셀에 입력가능하지 않은 데이터가 포함되어 있습니다."
    },
    "Memo": {
      "Head": "메모",
      "Delete": "삭제"
    ...
    "MenuCell": {
      ...
      "ChooseBorderColorItems": "<span style='background:%2;padding-left:15px;margin-right:5px;border-radius:50px;height:12px;font-size:12px;'></span>%1",
    ...
    "MenuColumns": {
      ...
      "SpaceCaption": "툴바 선택",
      "RowsCaption": "대상 행 선택",
      "FirstPrintHeadCaption": "헤더 인쇄 선택"
    },
    "MenuPrint": {
      "Caption": "프린트 설정",
      "PrintOptions": "프린트 옵션",
    ...
    "Debug": {
      ...
      "DataSavedSuccess": "시트 데이터 서버 저장 성공: ",
    ...
    "Accessibility": {
      "Required": "필수 입력",
      "AccCapInfo": " 열로 이루어진 테이블입니다.",
      "IBSheet": "아이비 시트",
      "AccDesc": "기준으로 내림차순 정렬됨",
      "AccAsc": "기준으로 오름차순 정렬됨",
      "BeginNotice": "%1 시트의 상단입니다.",
      "EndNotice": "%1 시트의 하단입니다.",
      "SectionLabel": "%1 시트 %2의 %3 영역",
      "SectionLeft": "왼쪽",
      "SectionMid": "가운데",
      "SectionRight": "오른쪽",
      "ColMove": "%1 컬럼이 %2 컬럼의 %3으로 이동했습니다.",
      "ColResize": "%1 컬럼 너비가 5px %2했습니다.",
      "ColSizeIncrease": "증가",
      "ColSizeDecrease": "감소",
      "SortStatus": "현재 정렬은 %1 순서입니다.",
      "SortCancel": "정렬이 취소되었습니다.",
      "SortAsc": "오름차순",
      "SortDesc": "내림차순",
      "SortButton": "정렬 버튼",
      "RadioGroup": "%1번째 라디오 그룹입니다.",
      "FileEmpty": " 파일이 없습니다",
      "FileHas": " 파일",
      "FileDeleteGuide": "파일을 삭제하려면 Delete 키를 입력하시고, ",
      "FileAddGuide": "파일을 추가 하려면 Enter 키 또는 Space 키를 입력하세요.",
      "FileClear": "파일이 삭제 되었습니다.",
      "IconClear": "삭제 아이콘",
      "IconDates": "달력 아이콘",
      "IconCheck": "선택 체크 아이콘",
      "IconUnCheck": "선택 해제 아이콘",
      "Filter": "%1 값이 %2 연산자로 필터링 되었습니다.",
      "NoFilter": "필터 연산자를 사용하지 않습니다.",
      "IconAllCancel": "전체 취소",
      "Button": "버튼",
      "Icon": "아이콘",
      "Clear": "삭제",
      ...
      "Check": "선택 체크",
      "UnCheck": "선택 해제",
      "TreeCollapse": "%1 기준 아래 %2개 행을 접었습니다.",
      "TreeExpand": "%1 기준 아래 %2개 행을 펼쳤습니다.",
      "IconTreeCollapse": "트리 접힘 아이콘",
      "IconTreeExpand": "트리 펼침 아이콘",
      "TreeLevel": "%1레벨 트리행 입니다.",
      "Menu": {
        "IconAllCancel": "전체 취소",
        "ItemSubMenu": "스페이스바를 누르시면 하위 메뉴를 열 수 있습니다.",
        "ItemExpand": "스페이스바를 누르시면 접혀있는 행을 펼칠 수 있습니다.",
        "ItemCollapse": "스페이스바를 누르시면 펼쳐있는 행을 접을 수 있습니다."
      },
      "Calendar": {
        "DayText": "일 선택",
        "MonthText": "선택",
        "YearText": "년 선택",
        "SelDate": "현재 선택되었습니다.",
        "MoveNextMonth": "다음달로 이동",
        "MoveBeforeMonth": "이전달로 이동",
        "MoveNext5Year": "다음 5년 이동",
        "MoveBefore5Year": "이전 5년 이동",
        "MoveDayCheck": "일 선택으로 이동",
        "MoveMonthCheck": "월 선택으로 이동"
      }
    },
    "BreakPoints": {
      "xs": 0,
    ...
    "Dialog": {
      "Reset": "초기화",
      "DragHere": "이곳으로 대상 컬럼을 끌어놓으십시오.",
      "HeaderTitle": "헤더타이틀",
      "Show": "보임",
      "ColumnName": "컬럼명",
      "SaveColumnInfo": "컬럼 정보 저장",
      "WillSave": "편집 내용을 저장하시겠습니까?",
      "EditDialog": "편집 다이얼로그",
      "Required": "필수",
      "Column": "컬럼",
      "Check": "체크",
      ...
      "DelRow": "행삭제",
      "ShowDetail": "설명보기",
      "NeedCommonFile": "ibsheet-excel.js 파일이 필요합니다.",
      "Caution": "경고",
      "Caution1": "오류 건에는 노란색 배경이 입혀집니다. 오류 건이 있으면 데이터 로드가 되지 않으므로 삭제하거나 수정 후 '확인' 버튼을 클릭하세요.",
      "Caution2": "업로드 다이얼로그는 엑셀파일의 첫행부터 순서대로 각 열에 대입합니다.",
      "Caution3": "숫자형 컬럼에는 숫자만 입력 가능합니다.",
      "Caution4": "드롭다운형식의 컬럼에는 리스트에 있는 데이터만 입력이 가능합니다.",
      "Caution5": "체크박스 유형의 컬럼에는  1(선택) 혹은 0(선택해제)로 입력이 가능합니다.",
      "Caution6": "텍스트 파일 업로드시, 파일에서 사용한 구분자와 다른 구분자로 적용할 경우 시트의 데이터가 올바르게 나오지 않을 수 있습니다.",
      "Caution7": "현재 오류 건(노란색)이 있습니다. 노란색으로 표시된 부분을 삭제 혹은 수정 후 '확인' 버튼을 클릭하세요.",
      "EnterSearchTerm": "검색어를 입력해주세요.",
      "EnterReplaceWord": "바꿀 내용을 정확하게 입력해주세요.",
      "SheetName": "시트 명",
      "FileName": "파일 명",
      "SetDelimiter": "구분자 설정",
      "ChooseRow4Load": "로드할 행을 선택해주세요.",
      "ChooseRow4Del": "삭제할 행을 선택해주세요.",
      "ChooseRow4Copy": "복사할 행을 선택해주세요.",
      "ChooseRow4Move": "이동할 행을 선택해주세요.",
      "ReplacedWord": "%d 건이 변경되었습니다.",
      "NoFindData": "검색 할 데이터가 없습니다.",
      "ChartTypes": "차트유형",
      "ChartData": "차트데이터",
      "Category": "카테고리",
      "Datas": "데이터 영역",
      ...
      "MatchEntireContent": "전체 내용 일치",
      "IncludeCanNotEdit": "편집 불가 포함",
      "UnCheck": "해제",
      "SelectColumn": "컬럼 선택",
      "FindAll": "모두 찾기",
      "PivotConfig": "피벗 테이블 설정",
      "ShowPivot": "피벗시트보기",
      "PivotInfoMsg": "아래 4개의 영역 안에 컬럼을 끌어 놓으십시오.",
      "PivotColSearch": "컬럼 이름을 검색해 보세요.",
      "PivotColDelete": "컬럼 우클릭을 통해 영역에서 제거 할 수 있습니다.",
      "Filter": "필터",
      "PivotDupColumn": "%d 필드는 중복 설정은 불가 합니다.",
      "PivotLayOutUpdate": "바로 업데이트",
      "PivotAll": "(모두)",
      "PivotSelected": "(다중 선택)",
      "ShowOrgSheet": "원본시트보기",
      "NormalColumn": "대상 컬럼(일반)",
      "NumericColumn": "대상 컬럼(숫자)",
      "BaseRow": "기준 행",
      "BaseCol": "기준 열",
      "PivotType": "피벗 타입",
      "SavePivotConfig": "피벗 정보 저장",
      "CreatePivot": "피벗 테이블 생성",
      "NoPossibleColumn": "가능한 대상 컬럼이 없습니다.",
      "NotComplete": "피벗 설정이 완료되지 않았습니다.",
      "DupDataWarn1": "열에 중복 데이터 개수 초과입니다. \n - 기준 열 중복 데이터 개수 : %d\n - 권장되는 열 데이터 개수",
      "DupDataWarn2": "행에 중복 데이터 개수 초과입니다. \n - 기준 행 중복 데이터 개수 : %d\n - 권장되는 행 데이터 개수",
      "WrongTypeWarn": "대상 컬럼의 타입이 맞지 않습니다.",
      "SortOrderTip": "가장 상위에 오는 행 부터 정렬 기준이 됩니다.",
      "TargetTip": "정렬 기준이 될 컬럼(열)을 선택합니다.",
      "OrderTip": "오름차순/내림차순 정렬 여부를 선택합니다.",
      "NumberSortTip": "데이터를 숫자형식으로 정렬 할지 여부를 선택합니다.",
      "RawSortTip": "정렬 데이터에 포맷 적용 여부를 선택합니다.\n콤보 리스트 순서 선택시 콤보 열에 리스트 순서대로 정렬이 됩니다.",
      "CaseSensitiveTip": "대소문자 구분 여부를 선택합니다.\n체크하는 경우 대소문자를 구분하여 정렬됩니다.",
      "SortOrder": "소팅순서",
      "BaseColumn": "기준 컬럼",
      "Sort": "정렬",
      "SortEnum": "|오름차순|내림차순",
      "SortType": "소팅 타입",
      "SortTypeEnum": "|문자 기준|숫자 기준",
      "UseFormat": "포멧 적용",
      "UseFormatEnum": "|포맷 데이터|순수 데이터|콤보 리스트 순서",
      "SortDialog": "정렬 다이얼로그",
      "AddCriteria": "기준 추가",
      "DelCriteria": "기준 삭제",
      "CopyCriteria": "기준 복사",
      "DelAllCriteria": "기준 전체 삭제",
      "SortWarn1": "모든 정렬 조건에는 지정된 열이 있어야 합니다. 선택한 정렬 조건을 확인하고 다시 시도하십시오.",
      "SortWarn2": "은(는) 값을 기준으로 두 번 이상 정렬되어 있습니다. 중복된 정렬 조건을 삭제하고 다시 시도하십시오.",
      "SortWarn3": "해당 시트의 최대 정렬 개수는 %d개 입니다.",
      "UseTooltipDataLabel": "툴팁/데이터 레이블 사용 여부",
      "Tooltip": "툴팁",
      "DataLabel": "데이터 레이블",
      "Palette": "색상 파레트",
      "LegendPos": "범례 위치",
      ...
      "Left": "좌측",
      "Right": "우측",
      "Use3d": "3d 차트 사용(막대와 파이 형 차트만 가능)",
      "Use": "3d 사용",
      "UsePivot": "데이터 피벗",
      "SwitchCategory": "카테고리/시리즈명 반전",
      "None": "없음",
      "Select": "선택",
      "DownloadColSave": "다운로드 항목 저장",
      "Config": "설정",
      "Download": "다운로드",
      ...
      "Zoom": "확대/축소",
      "TotalSum": "총합계",
      "TotalRowSum": "행 총합계 표시",
      "TotalColSum": "열 총합계 표시",
      "ChartType": {
        "LineType": "선형차트",
        "Line": "일반선형차트",
        "SPLine": "부드러운 꺽은선 차트",
        ...
        "ColumnType": "수직막대차트",
        "Column": "수직막대 일반차트",
        "StackedColumn": "수직막대 누적차트",
        "Stacked100Column": "수직막대 100% 누적차트",
        "BarType": "수평막대차트",
        "Bar": "수평막대 일반차트",
        "StackedBar": "수평막대 누적차트",
        "Stacked100Bar": "수평막대 100% 누적차트",
        "PieType": "파이차트",
        "Pie": "파이형 차트",
        "Doughnut": "도넛형 차트",
        "AreaType": "영역차트",
        "Area": "일반영역차트",
        "StackedArea": "누적영역차트",
        "Stacked100Area": "100% 누적영역차트",
        "ComplexChart": "복합차트",
        "ColumnArea": "세로막대+영역 차트",
        "ColumnLine": "세로막대+꺽은선 차트"
      },
      "ErrMsg": {
        "AtLeastOneData": "최소 1개의 데이터를 선택해야합니다.",
        "InvalidSetting": "카테고리가 없는 경우에는 설정할 수 없습니다.",
        "InvaildType": "선택한 Type이 올바르지 않습니다.",
        "MultipleSelected": "복수 영역 선택시 차트 생성이 불가능합니다.",
        "NeedChart": "IBChart js파일이 로드되지 않았습니다.",
        "NoSelectedRange": "선택된 영역이 존재하지 않습니다.",
        "NoCategory": "선택한 영역에 카테고리가 존재하지 않습니다.",
        "NoData": "선택된 영역에 데이터가 존재하지 않습니다."
      }
    }
  }
};